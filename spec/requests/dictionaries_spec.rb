...
RSpec.describe "project/dictionaries", type: :request do
      ...
      describe '自分のプロジェクト' do
        ...
        context '全てが公開中の場合' do
          example '正しく表示されること' do
            ...
            get project_dictionary_url(parent_project), headers: auth_params, as: :json
        ...
        context '全てが公開中の場合' do
          context "with valid parameters" do
            ...
            it "updates the requested dictionary" do
              ...
              patch project_dictionary_url(parent_project),
                    params: { dictionary: new_attributes }, headers: auth_params, as: :json
              dictionary.reload

              expect(dictionary.is_editable).to eq true
            end

            it "renders a json response with the dictionary" do
              auth_params = get_auth_params_from_login_response_headers(response)
          ...
          context "with invalid parameters" do
            it "renders a json response with errors for the dictionary" do
              auth_params = get_auth_params_from_login_response_headers(response)

              patch project_dictionary_url(parent_project),
                    params: { dictionary: { is_editable: nil } }, headers: auth_params, as: :json
      ...
      describe '他人のプロジェクト' do
        ...
        context '全てが公開中の場合' do
          context "with valid parameters" do
            ...
            it "renders a 403 error with the dictionary" do
              auth_params = get_auth_params_from_login_response_headers(response)
  ...
  describe '非login時' do
    describe "GET /show" do
      describe '他人のプロジェクト' do
        ...
        context '全てが公開中の場合' do
          example '正しく表示されること' do
            get project_dictionary_url(parent_project), as: :json
            expect(response).to be_successful
          end
        end
      ...
      describe '他人のプロジェクト' do
        ...
        context '全てが公開中の場合' do
          context "with valid parameters" do
            ...
            it "renders a 403 error with the dictionary" do
              patch project_dictionary_url(parent_project),
                    params: { dictionary: new_attributes }, as: :json
